...
[![R-CMD-check](https://github.com/aloy/ussie/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/aloy/ussie/actions/workflows/R-CMD-check.yaml)
[![test-coverage](https://github.com/aloy/ussie/actions/workflows/test-coverage.yaml/badge.svg)](https://github.com/aloy/ussie/actions/workflows/test-coverage.yaml)
<!-- badges: end -->
...
devtools::install_github("aloy/ussie")
```

## Example

This is a basic example of how to use `uss_make_matches()`:
